...
- SQL Database
    ...
    - [Analyze International Debt Statistics](https://github.com/rajatisace/bootcamp_projects/tree/main/SQL/Analyze%20International%20Debt%20Statistics) -DataCamp Project use postgreSQL to Analyze country debt by using Aggregate data with 'SUM()','MAX()','MIN()', filter row using 'WHERE','GROUP BY',use subquery in 'WHERE'
